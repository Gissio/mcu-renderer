...
/**
 * Macro for converting an RGB888 color code to an RGB565 color using rounding. Best color accuracy.
 *
...
/**
 * Macro for converting an RGB888 color code to an RGB565 color using truncating. Best for UIs.
 *
 * @param color_code The RGB888 color code.
 *
 * @return The RGB565 color.
 */
#define mr_get_color_truncated(color_code)         \
